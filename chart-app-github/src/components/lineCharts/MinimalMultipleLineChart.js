...
const MinimalMultipleLineChart = ({
  data,
  styling,
  chartName,
  numOfLines,
  ...
  useEffect(() => {
    ...
    let chart = root.container.children.push(
      am5xy.XYChart.new(root, {
        ...
        maxTooltipDistance: 200, // This influences how far off distances from the tooltip will be tracked
    ...
    for (let i = 0; i < numOfLines; i++) {
      ...
      let series = chart.series.push(
        am5xy.LineSeries.new(root, {
          name: lineNames[i], // Set the name of the series for reference or legend
          xAxis: xAxis, // Associate the series with the X-axis
          yAxis: yAxis, // Associate the series with the Y-axis
          valueYField: yAxisDataName, // Use the "value" field for the Y-axis values
          valueXField: xAxisDataName, // Use the "date" field for the X-axis values
...
export default MinimalMultipleLineChart
